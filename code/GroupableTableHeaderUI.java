...
class GroupableTableHeaderUI extends BasicTableHeaderUI{
	...
	public void paint(Graphics g, JComponent c){
	    ...
	    while (enumeration.hasMoreElements()){
	    	...
	    	aColumn.setMinWidth(25); //}min szer. kolumn	
	    	aColumn.setMaxWidth(40); //}max szer. kolumn
	    	aColumn.setPreferredWidth(40);
	    	...
	    	cellRect.width = aColumn.getWidth(); //+ columnMargin; //TUTAJ ZMIENIONA SZER. KOLUMN
	...
	private void paintCell(Graphics g, Rectangle cellRect, ColumnGroup cGroup){
	    ...
	    rendererPane.paintComponent(g, component, header, cellRect.x, cellRect.y,
	    		cellRect.width-3, cellRect.height, true); //naglowki zbiorcze
	}
